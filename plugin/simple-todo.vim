...
command! SimpleTodoDebug lua require('simple-todo.data').set_original_file_path(vim.fn.expand('%:p')); print("Using TODO file: " .. require('simple-todo.data').get_current_todo_file())